...
export class DeleteAllReducer extends Reducer
{
	public static reducerName: string = "DeleteAll";
	...
	public call(_id: number) {
		...
		this.client.call("DeleteAll", serializer);
	}
	...
	{
		this.client.on("reducer:DeleteAll", callback);
	}
}


export default DeleteAllReducer
