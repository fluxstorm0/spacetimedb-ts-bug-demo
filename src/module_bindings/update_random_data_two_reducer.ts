...
export class UpdateRandomDataTwoReducer extends Reducer
{
	public static reducerName: string = "UpdateRandomDataTwo";
	...
	public call(_id: number, _data: string) {
		...
		this.client.call("UpdateRandomDataTwo", serializer);
	}
	...
	{
		this.client.on("reducer:UpdateRandomDataTwo", callback);
	}
}


export default UpdateRandomDataTwoReducer
