...
export class AddDataReducer extends Reducer
{
	public static reducerName: string = "AddData";
	public static call() {
	...
	public call() {
		...
		this.client.call("AddData", serializer);
	}
	...
	{
		this.client.on("reducer:AddData", callback);
	}
}
